...
public class HTMLDocumentParser implements DocumentParser {
    ...
    public ProcessedDocument parse(FetchedDocument doc) 
       ...
       // System.out.println("doc content  :"+documentCharset);
    ...
    private void parseHTML(ProcessedDocument htmlDoc, InputSource inputSource) 
        ...
        try {
            ...
            throw new HTMLDocumentParserException("SAX Parsing error: ", e);
        } catch (IOException e) {
            throw new HTMLDocumentParserException("IO Parsing error: ", e);
        }
